...
class MonitorScreen extends EventEmitter_1.default {
    constructor() {
        super();
    ...
    createIframe() {
        ...
        // PROD
        iframe.src = 'https://mywebsite-os.vercel.app/';
        /**
    ...
    createCssPlane(element) {
        // Create CSS3D object
        const object = new CSS3DRenderer_js_1.CSS3DObject(element);
    ...
    update() {
        if (this.dimmingPlane) {
            ...
            const distance = Math.sqrt((camPos.x - dimPos.x) ** 2 +
                (camPos.y - dimPos.y) ** 2 +
                (camPos.z - dimPos.z) ** 2);
